...
public class EditProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnFinishEditProfile) {
            ...
            Profile profile = new Profile(editTextEditProfileName.getText().toString(),
            ...
            profile.setFriendsId(oldProfile.getFriendsId());
            profile.setListOfGroups(oldProfile.getListOfGroups());
            profile.setListOfEvents(oldProfile.getListOfEvents());
            profile.setPendingFriendsId(oldProfile.getPendingFriendsId());
