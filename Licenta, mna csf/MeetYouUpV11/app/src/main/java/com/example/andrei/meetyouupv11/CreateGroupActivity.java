    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnContinueGroup) {
            if (firebaseAuth.getCurrentUser() != null) {
                Group group = new Group(firebaseAuth.getCurrentUser().getUid().toString(), createGroupName.getText().toString(),
                ...
                databaseReference.child(groupUID).setValue(group).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        startActivity(new Intent(CreateGroupActivity.this, AddPeopleToGroupActivity.class));
                    }
