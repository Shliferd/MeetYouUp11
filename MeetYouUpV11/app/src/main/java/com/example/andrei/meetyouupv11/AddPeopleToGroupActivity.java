            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReferenceGroup.setValue(newGroup).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(AddPeopleToGroupActivity.this, "Group created!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            myRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    myRef.setValue(newProfile).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(AddPeopleToGroupActivity.this, "Users group info updated!", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
